<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800 tracking-tight">{{ __('Dompet Saya') }}</h2>
                <p class="text-sm text-gray-500 mt-1">Kelola saldo dan rekening Anda</p>
            </div>
                ...
                @forelse ($wallets as $wallet)
                    ...
                    <div
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-3xl font-extrabold text-gray-900 mt-2 tracking-tight">
                                Rp {{ number_format($wallet->balance, 0, ',', '.') }}
                            </p>
                            <p class="text-xs font-medium text-gray-500 mt-1 uppercase tracking-wide">Saldo saat ini</p>

                            <div
                                class="mt-6 pt-4 border-t border-gray-100 flex justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity duration-200">
                                ...
                                <div x-data="{ openDelete: false }" class="inline">
                                    ...
                                    <div x-show="openDelete"
                                        ...
                                        <div x-show="openDelete" x-transition:enter="ease-out duration-300"
                                            ...
                                            <h3 class="text-lg font-bold text-gray-900 mb-1">Hapus Dompet?</h3>
                                            <p class="text-xs text-red-500 font-semibold mb-2">Peringatan Kritis!</p>
                                            <p class="text-xs text-gray-500 mb-6 leading-relaxed whitespace-normal">
                                                Menghapus dompet <span
                                                    class="font-bold text-gray-700">{{ $wallet->name }}</span> akan
                                                menghapus <strong>seluruh riwayat transaksi dan mutasi</strong> yang
                                                terhubung dengan dompet ini secara permanen.
                                            </p>

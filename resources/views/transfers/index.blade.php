    ...
    <div class="py-8">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white rounded-xl shadow-md border border-gray-100 overflow-hidden">
                            ...
                            @forelse ($transfers as $tf)
                                <tr class="hover:bg-gray-50 transition-colors duration-150">
                                    <td class="px-5 py-4 whitespace-nowrap text-sm text-gray-600">
                                        {{ \Carbon\Carbon::parse($tf->date)->format('d M Y') }}
                                    </td>
                                    <td class="px-5 py-4 whitespace-nowrap text-sm">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <div>
                                                <span
                                                    class="font-medium text-gray-900">{{ $tf->fromWallet->name }}</span>
                                                <div class="text-xs text-gray-400 font-normal truncate max-w-[150px]">
                                                    {{ $tf->description ?? 'Transfer Keluar' }}
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-5 py-4 whitespace-nowrap text-sm">
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="font-medium text-gray-900">{{ $tf->toWallet->name }}</span>
                                        </div>
                                    </td>
                                            ...
                                            <div x-data="{ openDelete: false }" class="inline">
                                                ...
                                                <div x-show="openDelete"
                                                    ...
                                                    <div x-show="openDelete" x-transition:enter="ease-out duration-300"
                                                        ...
                                                        <h3 class="text-lg font-bold text-gray-900 mb-1">Batalkan
                                                            Mutasi?</h3>
                                                        <p
                                                            class="text-xs text-gray-500 mb-6 leading-relaxed whitespace-normal">
                                                            Riwayat transfer sebesar <span
                                                                class="font-semibold text-gray-700">Rp
                                                                {{ number_format($tf->amount, 0, ',', '.') }}</span>
                                                            akan dihapus. Saldo pada kedua dompet terkait akan
                                                            dikembalikan seperti semula secara otomatis.
                                                        </p>
                                                        ...
                                                        <div class="flex justify-center gap-3">
                                                            ...
                                                            <form action="{{ route('transfers.destroy', $tf) }}"
                ...
                @if (method_exists($transfers, 'links') && $transfers->hasPages())
